...
const SUPABASE_KEY =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imdja3NiZnN0aGVhdnBmZ2NkbmRiIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3Nzc1MDcyNywiZXhwIjoyMDkzMzI2NzI3fQ.yuYxAYnllivwnR7fKzEAfgUIdLEAQZjIBAPrWfQh0IY"; // Coloque a sua chave Service Role verdadeira aqui
...
function buildPayload(sheetName, rowData) {
  ...
  if (sheetName === "Controle EPI e Fardamento") {
    ...
    config.fields.forEach((field, index) => {
      ...
      // Se for o campo mes_ref e for uma data válida, forçamos o formato MM/YYYY para respeitar o limite de 7 caracteres
      if (field === "mes_ref" && val instanceof Date) {
