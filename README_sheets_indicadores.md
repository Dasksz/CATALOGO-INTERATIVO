...
Colunas esperadas na linha 1: `funcionario_nome`, `data_admissao`, `data_desligamento`, `motivo_saida`

**Regras:**
* O sistema calcula tudo de forma automática baseada nas datas de admissão e desligamento.
...
| funcionario_nome | data_admissao | data_desligamento | motivo_saida |
| :--- | :--- | :--- | :--- |
